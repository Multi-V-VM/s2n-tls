...
typedef enum {
    ...
    /* Add attestation specific error codes */
    S2N_ERR_INVALID_ATTESTATION_TYPE = S2N_ERR_T_ALERT_START + 50,
    S2N_ERR_ATTESTATION_EVIDENCE_VERIFICATION_FAILED,
    S2N_ERR_ATTESTATION_EVIDENCE_MISSING,
